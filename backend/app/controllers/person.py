...
from schema import ResponseSchema, PersonCreate
...
async def create_person(create_form: PersonCreate):
    await PersonRepository.create_person(create_form)
...
async def get_person_by_id(
    ...
    result = await PersonRepository.delete(person_id)
...
async def get_all_people(
    ...
    return ResponseSchema(detail="Successful fetchall", result=result)
